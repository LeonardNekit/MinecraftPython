...
try:
    ...
    print('У вас нет библиотеки minecraft_launcher_lib, пожалуйста скачайте данную библиотеку через pip')
import subprocess

minecraft_directory = minecraft_launcher_lib.utils.get_minecraft_directory().replace('minecraft', 'chto_za_zalupa')

print('Привет')
print('Ты попал в лаунчер для майна, здесь нет реклам, доп. контентов и интерфейса для слабых устройства')
print('Для скачивания, потребуется java se!')
